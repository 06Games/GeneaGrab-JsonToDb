using System.Text;
using GeneaGrab_JsonToDb.Old.Dates.Calendars.FrenchRepublican;
using GeneaGrab_JsonToDb.Old.Dates.Calendars.Gregorian;
using GeneaGrab_JsonToDb.Old.Dates.Calendars.Julian;
using Newtonsoft.Json;

namespace GeneaGrab_JsonToDb.Old.Dates
{
